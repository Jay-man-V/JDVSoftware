...
namespace Foundation.ViewModels
{
    ...
    public class ContactDetailViewModel : GenericDataGridViewModelBase<IContactDetail>, IContactDetailViewModel
    {
        ...
        {
            LoggingHelpers.TraceCallEnter(core, runTimeEnvironmentSettings, dateTimeService, dialogService, clipBoardWrapper, fileApi, contactDetailProcess, contactTypeProcess);
