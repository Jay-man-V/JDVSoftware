...
namespace Foundation.ViewModels
{
    ...
    public class ErrorDialogViewModel : MessageDialogViewModel
    {
        ...
        {
            LoggingHelpers.TraceCallEnter(core, runTimeEnvironmentSettings, dateTimeService, dialogService, clipBoardWrapper, targetWindow, parentViewModel, exception, continueVisibility);
