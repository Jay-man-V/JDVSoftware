...
namespace NationalLottery.Models
{
    ...
    /// <seealso cref="ILottoResults" />
    [DependencyInjectionTransient]
    public class LottoResults : NationalLotteryModel, ILottoResults
    {
        /// <inheritdoc cref="ICloneable.Clone()"/>
        public override Object Clone()
        {
            LottoResults retVal = base.Clone() as LottoResults;
        ...
        public override Boolean Equals(Object obj)
        {
            ...
            if (obj.IsNotNull() &&
                obj is LottoResults LottoResults)
            {
                retVal = InternalEquals(this, LottoResults);
            }
        ...
        /// <returns></returns>
        public Boolean Equals(LottoResults other)
        {
            Boolean retVal = false;
        ...
        /// </returns>
        public static Boolean operator ==(LottoResults left, LottoResults right)
        {
            Boolean retVal = false;
        ...
        /// <param name="right">The right object.</param>
        /// <returns></returns>
        private static Boolean InternalEquals(LottoResults left, LottoResults right)
        {
            Boolean retVal = true;
