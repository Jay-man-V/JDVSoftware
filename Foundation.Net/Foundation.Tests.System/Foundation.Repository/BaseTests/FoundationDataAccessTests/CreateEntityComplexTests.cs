//-----------------------------------------------------------------------
// <copyright file="ComplexSaveNewEntityTests.cs" company="JDV Software Ltd">
...
namespace Foundation.Tests.System.Foundation.Repository.BaseTests.FoundationDataAccessTests
{
    ...
    [TestFixture]
    public class CreateEntityComplexTests : DataAccessSystemTestBase
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public void Test_Properties()
        {
            ...
            ApplicationRole applicationRole = ApplicationRole.Creator;
            ApplicationRole actualApplicationRole = obj.GetRequiredMinimumCreateRole();

            Assert.That(actualApplicationRole, Is.EqualTo(applicationRole));
        }
        ...
        public void Test_SaveNullEntity()
        {
            ...
            //try
            //{
            //    ComplexTestEntityRepository obj = new ComplexTestEntityRepository(DateTimeService);
        ...
        /// </summary>
        [TestCase]
        public void Test_SaveValidEntity()
        {
            ComplexTestEntityRepository obj = BaseTestsHelpers.CreateComplexProcess(CoreInstance, RunTimeEnvironmentSettings, DateTimeService);
