...
namespace Foundation.ViewModels
{
    ...
    public class ApplicationConfigurationViewModel : GenericDataGridViewModelBase<IApplicationConfiguration>, IApplicationConfigurationViewModel
    {
        ...
        {
            LoggingHelpers.TraceCallEnter(core, runTimeEnvironmentSettings, dateTimeService, dialogService, clipBoardWrapper, fileApi, applicationConfigurationProcess, configurationScopeProcess, applicationProcess);
