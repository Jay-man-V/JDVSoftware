...
namespace Foundation.ViewModels
{
    ...
    public class NonWorkingDayViewModel : GenericDataGridViewModelBase<INonWorkingDay>, INonWorkingDayViewModel
    {
        ...
        {
            LoggingHelpers.TraceCallEnter(core, runTimeEnvironmentSettings, dateTimeService, dialogService, clipBoardWrapper, fileApi, nonWorkingDayProcess, countryProcess);
