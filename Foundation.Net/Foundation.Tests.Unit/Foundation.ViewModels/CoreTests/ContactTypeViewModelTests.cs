...
namespace Foundation.Tests.Unit.Foundation.ViewModels.CoreTests
{
    ...
    public class ContactTypeViewModelTests : GenericDataGridViewModelTestBaseClass<IContactType, IContactTypeViewModel, IContactTypeProcess>
    {
        ...
        {
            IContactTypeViewModel viewModel = new ContactTypeViewModel(CoreInstance, RunTimeEnvironmentSettings, dateTimeService,DialogService, ClipBoardWrapper, FileApi, BusinessProcess);
            GenericDataGridViewModelBase<IContactType> genericDataGridViewModel = (GenericDataGridViewModelBase<IContactType>)viewModel;
